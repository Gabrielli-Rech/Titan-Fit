...
<?php endif; ?>
    ...
    <main>
        <section class="fale-conosco">
            <br>
            <h1>Fale Conosco</h1>
            <p>Entre em contato com a equipe Titan Fit! Estamos prontos para ajudar.</p>
            <br>
            <div class="container-contato">
                ...
                <div class="info-contato">
                    ...
                    <p><strong>📍 Endereço:</strong> Rua Fitness, 123 - Porto Alegre, RS</p>
                    <p><strong>📞 Telefone:</strong> (51) 9999-9999</p>
                    <p><strong>📧 E-mail:</strong> contato@titanfit.com</p>
                </div>
            </div>
        </section>
    ...
    <script src="../Script.js"></script>
    <script src="../JavaScript/fale-conosco.js"></script>
</body>
